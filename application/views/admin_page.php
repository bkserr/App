		...
		<div class="main_container">
			<div class="col-md-3 left_col">
		        <div class="left_col scroll-view">
                  ...
                  <li class=""><a><i class="fa fa-edit"></i> Users <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu" style="display: none;">
                      <li><a href="form.html">Create User</a></li>
                      <li><a href="form_advanced.html">View Users</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-desktop"></i> Groups <span class="fa fa-chevron-down"></span></a>
